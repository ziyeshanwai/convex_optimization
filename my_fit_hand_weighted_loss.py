...
if __name__ == "__main__":
    ...
    for j in range(0, number_frames):
        Cors, confidences = get_Cordinate(Frames_keypoints, j)
        last_loss = 1000
        if i == 0:
    ...
    save_pickle_file(os.path.join("D:\\pycharm_project\\Fit_hands\\manopth\\hand_output", "r_hand.pkl"), Hand_joints_list)
